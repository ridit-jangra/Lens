...
const PHRASES: Record<string, string[]> = {
  general: [
    ...
    "rebasing thoughts... 🔄",
    "compiling feelings... 🛠️",
    "hot reloading ideas... ♻️",
    "touching grass mentally... 🌱",
    "npm install wisdom... 📦",
    "resolving merge conflicts in head... ⚔️",
